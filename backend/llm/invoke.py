...
def get_operation_type(command: str) -> dict:
    ...
    operation_keywords = {
        "delete": ["삭제", "지우", "지워", "delete", "제거", "remove", "없애"],
        "create_folder": ["폴더생성", "폴더만들", "폴더추가", "create", "새폴더", "디렉토리생성", "폴더만드", "만들어", "생성해", "만들고"],
        "rename": ["이름변경", "이름바꾸", "이름수정", "rename", "제목변경", "제목바꾸", "수정하고"],
        "move": ["이동", "옮기", "옮겨", "move", "이사", "위치변경", "옮겨달", "이동해"],
        "copy": ["복사", "copy", "복제", "백업", "복사해", "복제해"],
        "summarize": ["요약", "summarize", "요약해", "summary"],
        "search": ["검색", "찾", "찾아", "search", "조회", "탐색", "찾아줘"]
    }
