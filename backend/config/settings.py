...
# 로컬 Windows 환경에서 사용할 URL
    ...
    # 로컬 Windows 환경에서 사용할 URL
    DATABASE_URL = "postgresql+psycopg://postgres:postgres@localhost:5432/ragdb?client_encoding=utf8"
    # 프로그램 종료 시 까지 이 주소를 유지
    os.environ['DATABASE_URL'] = DATABASE_URL
else:
    # Docker 환경에서 사용할 URL
    DATABASE_URL = "postgresql+psycopg://postgres:postgres@db:5432/ragdb?client_encoding=utf8"
    # Docker 환경 변수 설정
